    ...
    <div className="flex flex-col space-y-3 items-center pt-4">
      ...
      <div className="flex space-x-8 pt-4 text-white">
        <div className="flex flex-col space-y-2">
          <a className="h-16 w-16 rounded-full bg-red-400 flex items-center justify-center cursor-pointer hover:scale-105 hover:rotate-6 transform transition-transform">
